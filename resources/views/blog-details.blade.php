  ...
  <div class="body_content">
    ...
    <section class="our-blog pt40">
          ...
          <div class="col-lg-12">
            ...
            <div class="blog-single-meta">
              <div class="post-author d-sm-flex align-items-center">
                <img class="mr10" src="{{asset('assets/images/blog/author-1.png')}}" alt=""><a class="pr15 body-light-color" href="#">Leslie Alexander</a><a class="ml15 pr15 body-light-color" href="#">Business</a><a class="ml15 body-light-color" href="#">December 2, 2022</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mx-auto maxw1600 mt60 wow fadeInUp" data-wow-delay="300ms">
        <div class="row">
          <div class="col-lg-12">
            <div class="large-thumb"><img class="w-100 bdrs16" src="{{asset('assets/images/blog/blog-single-1.jpg')}}" alt=""></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="roww wow fadeInUp" data-wow-delay="500ms">
          <div class="col-xl-8 offset-xl-2">
            ...
            <div class="col-lg-12 mt40">
              <img src="{{asset('assets/images/blog/blog-single-2.jpg')}}" alt="" class="bdrs4 post-img-2 w-100">
            </div>
            ...
            <div class="bsp_comments bdrb1 d-block d-sm-flex justify-content-between pt30 pb45 pb30-sm">
              <div class="mbp_first d-flex">
                <div class="flex-shrink-0"> <img src="{{asset('assets/images/blog/comments-1.png')}}" class="mr-3" alt="comments-1.png"> </div>
    ...
    <section class="bgc-thm3 pb90 pb30-md">
      <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="blog-style1">
              <div class="blog-img"><img class="w-100" src="{{asset('assets/images/blog/blog-4.jpg')}}images/blog/blog-4.jpg" alt=""></div>
              <div class="blog-content">
                <a class="date" href="#">December 2, 2022</a>
