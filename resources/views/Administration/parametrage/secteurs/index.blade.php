                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ui-content">
                                <hr class="bg-dark">
                                <h3 class="title text-center">Listes des secteurs (
                                    <b>{{ $secteurs->count() }}<b> au total)
                                </h3>
                                <hr class="bg-dark">

                                <a href="{{ route('secteurs.create') }}" class="ud-btn btn-dark mb25 me-4">Ajouter</a>
                                <div class="table-style1 table-responsive mb-4 mb-lg-5">
                                    <table id="maintable"
                                        ...
                                        <tbody>
                                                    ...
                                                    <td width="20%">
                                                        <center>
                                                            <div class="row mr-0 text-white">
                                                                <div class="col-md-3">
                                                                    <a
                                                                        href="{{ route('secteurs.show', $val->id) }}"class="btn btn-info text-white"title="Informations supplementaires sur cet Enregistrement"><i
                                                                            class="fa fa-eye"></i></a>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('secteurs.edit', $val->id) }}"class="btn btn-warning text-white"title="Modifier cet Enregistrement"><i
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <form
                                                                        method="POST"action={{ route('secteurs.destroy', $val->id) }}>
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="4"class="text-center">Aucun enregistrement trouv&eacute;
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
