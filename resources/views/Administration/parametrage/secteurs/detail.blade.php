                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                <label class="form-label fw500 fz16 dark-color">Saisissez le
                                    Libell&eacute; du departement</label>
                                <div class="bootselect-multiselect">
                                    <input required type="text" name="libelle" value="{{ $secteurs->libelle ?? '' }}"
                                        class="form-control" disabled placeholder="Saisissez le Libelle du departement">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="bootselect-multiselect">
                                    <select class="selectpicker" disabled name="idDepartement" data-live-search="true"
                                        data-width="100%">
                                        <option>Selectionner ici...</option>
                                        @forelse ($departements as $val)
                                        <option {{ $val->id == $secteurs->idDepartement ? 'selected ' : '' }}
                        ...
                        <center>
                            <div class="col-sm-3 mt-1">
                                <div class="form-group mt-1 ">
                                    <a href="/secteurs" class="btn btn-danger text-white p-2 ">Retour</a>
