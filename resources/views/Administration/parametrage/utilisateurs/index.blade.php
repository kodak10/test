                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ui-content">
                                <hr class="bg-dark">
                                <h3 class="title text-center">Listes des Comptes Utlisateurs (
                                    <b>{{ $User->count() }}<b> au total)
                                </h3>
                                <hr class="bg-dark">

                                <a href="{{ route('acces_utilisateurs.create') }}" class="ud-btn btn-dark mb25 me-4">Ajouter</a>
                                    ...
                                    <table id="maintable"
                                        ...
                                        <thead class="thead-light">
                                            <tr class="text-center">
                                                ...
                                                <th class="fz15 fw500" scope="col">Nom et Prenom(s)</th>
                                                <th class="fz15 fw500" scope="col">Email</th>
                                                <th class="fz15 fw500" scope="col">Profil</th>
                                        ...
                                        <tbody>
                                            @forelse($User as $val)
                                                <tr class="text-center">
                                                    ...
                                                    <td>{{ $val->email }}</td>
                                                    <td>{{ ($val->isAdmin==1)?'SERVICE CLIENT':'ENTREPRISE/PARTICULIER' }}</td>
                                                    <td width="20%">
                                                        <center>
                                                            <div class="row mr-0 text-white">
                                                                <div class="col-md-3">
                                                                    <a
                                                                        href="{{ route('acces_utilisateurs.show', $val->id) }}"class="btn btn-info text-white"title="Informations supplementaires sur cet Enregistrement"><i
                                                                            class="fa fa-eye"></i></a>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('acces_utilisateurs.edit', $val->id) }}"class="btn btn-warning text-white"title="Modifier cet Enregistrement"><i
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <form
                                                                        method="POST"action={{ route('acces_utilisateurs.destroy', $val->id) }}>
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button
