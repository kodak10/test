                ...
                <div class="dashboard__content hover-bgc-color">
                    ...
                    <div class="col-lg-12">
                        <div class="ui-content">
                            <hr class="bg-dark">
                            <h3 class="title text-center">Modifier un Compte utilisateur</h3>
                            <hr class="bg-dark">
                            <a href="/acces_utilisateurs" class="ud-btn btn-dark mb25 me-4">Liste des acces_utilisateurs</a>
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="{{ route('acces_utilisateurs.update', $User->id) }}" method="post">
                                        @method('PATCH')
                                        @csrf
                                        <div class="row mr-4 ml-4">
                                            ...
                                            <div class="col-sm-3 mt-1">
                                                <div class="form-group mt-1 ">
                                                    ...
                                                    <a
                                                        href="/acces_utilisateurs"class="btn btn-danger text-white p-2 ">Retour</a>
