...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:19 GMT -->
<head>
<meta charset="utf-8">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard-message.html"><i class="flaticon-chat mr10"></i>Message</a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="page-dashboard-message.html" class="items-center -is-active"><i class="flaticon-chat mr15"></i>Message</a>
          </div>
          <div class="sidebar_list_item ">
              ...
              <div class="dashboard_navigationbar d-block d-lg-none">
                <div class="dropdown">
                  ...
                  <ul id="myDropdown" class="dropdown-content">
                    ...
                    <li class="active"><a href="page-dashboard-message.html"><i class="flaticon-chat mr10"></i>Message</a></li>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:25 GMT -->
</html>