...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-job-list-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:10 GMT -->
<head>
<meta charset="utf-8">
          ...
          <div class="accordion" id="accordionExample2">
            ...
            <div class="card mb20 pb0">
              <div class="card-header" id="headingOnes">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOnes" aria-expanded="true" aria-controls="collapseOnes">Salary</button>
                </h4>
              </div>
            ...
            <div class="card mb20 pb5">
              <div class="card-header" id="headingTwos">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwos" aria-expanded="true" aria-controls="collapseTwos">Job Type</button>
                </h4>
              </div>
                  ...
                  <div class="widget-wrapper pr20">
                    <div class="switch-style1">
                      <div class="form-check form-switch mb20">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckDefault5">Freelance</label>
                        <span class="right-tags">(1,945)</span>
                      </div>
                    </div>
                    <div class="switch-style1">
                      <div class="form-check form-switch mb20">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault6" checked="checked">
                        <label class="form-check-label" for="flexSwitchCheckDefault6">Full Time</label>
                        <span class="right-tags">(8,136)</span>
                      </div>
                    </div>
                    <div class="switch-style1">
                      <div class="form-check form-switch mb20">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckDefault7">Part Time</label>
                        <span class="right-tags">(917)</span>
                      </div>
                    </div>
                    <div class="switch-style1">
                      <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckDefault8">Internship</label>
                        <span class="right-tags">(240)</span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="card mb20 pb5">
              <div class="card-header" id="headingThrees">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThrees" aria-expanded="true" aria-controls="collapseThrees">Level</button>
                </h4>
              </div>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="card mb20 pb0">
                  <div class="card-header active" id="heading1">
                    <h4>
                      <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">Salary</button>
                    </h4>
                  </div>
                ...
                <div class="card mb20 pb5">
                  <div class="card-header active" id="heading2">
                    <h4>
                      <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2">Job Type</button>
                    </h4>
                  </div>
                ...
                <div class="card mb20 pb5">
                  <div class="card-header active" id="heading3">
                    <h4>
                      <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="true" aria-controls="collapse3">Level</button>
                    </h4>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="job-list-style1 bdr1">
                  ...
                  <div class="details">
                    <h5 class="mb20">Office assistant/Social media <br class="d-none d-md-block"> assistant</h5>
                    <p class="list-inline-item mb-3">$125k-$135k Hourly</p>
                    <p class="list-inline-item mb-3 bdrl1 pl15">1-5 Days</p>
                    <p class="list-inline-item mb-0 bdrl1 pl15">Expensive</p>
                    <p class="list-inline-item mb-0 bdrl1 pl15">Remote</p>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="job-list-style1 bdr1">
                  ...
                  <div class="details">
                    <h5 class="mb20">Marketing and Communications <br class="d-none d-md-block"> Manager</h5>
                    <p class="list-inline-item mb-3">$125k-$135k Hourly</p>
                    <p class="list-inline-item mb-3 bdrl1 pl15">1-5 Days</p>
                    <p class="list-inline-item mb-0 bdrl1 pl15">Expensive</p>
                    <p class="list-inline-item mb-0 bdrl1 pl15">Remote</p>
