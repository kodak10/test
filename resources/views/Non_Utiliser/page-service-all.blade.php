...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-service-all.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:04 GMT -->
<head>
<meta charset="utf-8">
    ...
    <section class="pt0 pb90">
      <div class="container">
        ...
        <div class="row mt35">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="listing-style1 style3">
              <div class="list-thumb">
                <img class="w-100" src="images/listings/g-1.jpg" alt="">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
              </div>
        ...
        <div class="row mt35">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="listing-style1 style5">
              ...
              <div class="list-content px-0">
                <p class="list-text body-color fz14 mb-1">Art & Illustration</p>
                <h5 class="list-title"><a href="page-services-single.html">I will create modern flat design <br class="d-none d-md-block"> illustration</a></h5>
                <div class="review-meta d-flex align-items-center">
                  <i class="fas fa-star fz10 review-color me-2"></i>
                  <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                </div>
          ...
          <div class="col-md-6">
            <div class="listing-style1 list-style d-block d-xl-flex align-items-center">
              <div class="list-thumb flex-shrink-0">
                <div class="listing-thumbIn-slider position-relative navi_pagi_bottom_center slider-1-grid owl-carousel owl-theme">
                  <div class="item">
                    <img class="" src="images/listings/g-2.jpg" alt="">
                  </div>
                  <div class="item">
                    <img class="" src="images/listings/g-3.jpg" alt="">
                  </div>
                  <div class="item">
                    <img class="" src="images/listings/g-4.jpg" alt="">
                  </div>
                  <div class="item">
                    <img class="" src="images/listings/g-5.jpg" alt="">
                  </div>
                </div>
              </div>
              <div class="list-content flex-grow-1 ms-1">
        ...
        <div class="row mt35">
          ...
          <div class="col-md-9">
            <div class="listing-style1 listi-style2 d-block d-xl-flex align-items-center">
              <div class="list-thumb flex-shrink-0">
                <img class="w-100" src="images/listings/g-1.jpg" alt="">
              </div>
              <div class="list-content flex-grow-1 ms-1">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                <p class="list-text body-color fz14 mb-1">Web & App Design</p>
                <h5 class="list-title mb-2"><a href="page-services-single.html">I will design modern websites in figma or adobe xd</a></h5>
                <p class="list-text body-color fz15 mb-1">I can assist you in designing clean and minimal UI UX for your website in Adobe XD or <br> Figma.</p>
                <div class="review-meta d-flex align-items-center">
                  <i class="fas fa-star fz10 review-color me-2"></i>
                  <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                </div>
            ...
            <div class="listing-style1 listi-style2 d-block d-xl-flex align-items-center">
              ...
              <div class="list-content flex-grow-1 ms-1">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                <p class="list-text body-color fz14 mb-1">Design & Creative</p>
                <h5 class="list-title line-clamp1 mb-2"><a href="page-services-single.html">I will build a fully responsive design in HTML,CSS, bootstrap, and javascript</a></h5>
                <p class="list-text body-color fz15 mb-1">I can assist you in designing clean and minimal UI UX for your website in Adobe XD or <br> Figma.</p>
                <div class="review-meta d-flex align-items-center">
                  <i class="fas fa-star fz10 review-color me-2"></i>
                  <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
        ...
        <div class="row mt35">
          <div class="col-lg-12 mb15">
            <h2>List Stytle V8</h2>
            <p class="text">Give your visitor a smooth online experience with a solid UX design</p>
          </div>
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-5">
          <div class="col">
            <div class="listing-style1 style8">
              <div class="list-thumb">
                <img class="w-100" src="images/listings/g-13.jpg" alt="">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
              </div>
              <div class="list-content">
                <p class="list-text body-color fz14 mb-1">Web & App Design</p>
          ...
          <div class="col">
            <div class="listing-style1 style8">
              <div class="list-thumb">
                <img class="w-100" src="images/listings/g-14.jpg" alt="">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
              </div>
              <div class="list-content">
                <p class="list-text body-color fz14 mb-1">Art & Illustration</p>
          ...
          <div class="col">
            <div class="listing-style1 style8">
              <div class="list-thumb">
                <img class="w-100" src="images/listings/g-15.jpg" alt="">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
              </div>
              <div class="list-content">
                <p class="list-text body-color fz14 mb-1">Design & Creative</p>
          ...
          <div class="col">
            <div class="listing-style1 style8">
              <div class="list-thumb">
                <img class="w-100" src="images/listings/g-16.jpg" alt="">
                <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
              </div>
              <div class="list-content">
                <p class="list-text body-color fz14 mb-1">Web & App Design</p>
                <h6 class="list-title line-clamp2"><a href="page-services-single.html">I will do mobile app development for ios and android</a></h6>
                <div class="review-meta d-flex align-items-center">
                  <i class="fas fa-star fz10 review-color me-2"></i>
                  <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                </div>
          ...
          <div class="col">
            <div class="listing-style1 style8">
              ...
              <div class="list-content">
                <p class="list-text body-color fz14 mb-1">Art & Illustration</p>
                <h6 class="list-title line-clamp2"><a href="page-services-single.html">I will create modern flat design illustration</a></h6>
                <div class="review-meta d-flex align-items-center">
                  <i class="fas fa-star fz10 review-color me-2"></i>
                  <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                </div>
