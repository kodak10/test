...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-job-list-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:10 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="col-xl-8 mx-auto">
              <div class="position-relative">
                <div class="list-meta d-lg-flex align-items-end justify-content-between">
                  ...
                  <a href="page-contact.html" class="ud-btn btn-thm2">Apply For Job<i class="fal fa-arrow-right-long"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row wow fadeInUp">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="service-about">
              ...
              <h4 class="mb30">Key Responsibilities</h4>
              <div class="list-style1 mb60 pr50 pr0-lg">
                <ul>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Be involved in every step of the product design cycle from discovery to developer handoff and user acceptance testing.</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Work with BAs, product managers and tech teams to lead the Product Design</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Maintain quality of the design process and ensure that when designs are translated into code they accurately reflect the design specifications.</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Accurately estimate design tickets during planning sessions.</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Contribute to sketching sessions involving non-designersCreate, iterate and maintain UI deliverables including sketch files, style guides, high fidelity prototypes, micro interaction specifications and pattern libraries.</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Ensure design choices are data led by identifying assumptions to test each sprint, and work with the analysts in your team to plan moderated usability test sessions.</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Design pixel perfect responsive UI’s and understand that adopting common interface patterns is better for UX than reinventing the wheel</li>
                  <li><i class="far fa-check text-thm3 bgc-thm3-light"></i>Present your work to the wider business at Show & Tell sessions.</li>
                </ul>
              </div>
              <h4 class="mb30">Work & Experience</h4>
              <ul class="list-style-type-bullet ps-3 mb60">
              ...
              <div class="main-title mb30">
                <h2>Related Jobs</h2>
                <p class="text">2022 jobs live - 293 added today</p>
              </div>
              <div class="row">
                <div class="col-sm-6 col-xl-12">
                  <div class="job-list-style1 bdr1 d-xl-flex align-items-start">
                    ...
                    <div class="details ml20 ml0-xl">
                      ...
                      <p class="list-inline-item mb-0 bdrl1 pl15">1-5 Days</p>
                ...
                <div class="col-sm-6 col-xl-12">
                  <div class="job-list-style1 bdr1 d-xl-flex align-items-start">
                    ...
                    <div class="details ml20 ml0-xl">
                      ...
                      <h6 class="mb-3 text-thm">Invision</h6>
                      <p class="list-inline-item mb-0">$125k-$135k Hourly</p>
                      <p class="list-inline-item mb-0 bdrl1 pl15">1-5 Days</p>
                      <p class="list-inline-item mb-0 bdrl1 pl15">Expensive</p>
                      <p class="list-inline-item mb-0 bdrl1 pl15">Remote</p>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-job-list-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:11 GMT -->
</html>