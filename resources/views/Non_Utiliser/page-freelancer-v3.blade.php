...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-freelancer-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:45 GMT -->
<head>
<meta charset="utf-8">
          ...
          <div class="accordion" id="accordionExample2">
            <div class="card mb20 pb10">
              <div class="card-header active" id="headingZero">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseZero" aria-expanded="true" aria-controls="collapseZero">Skills</button>
                </h4>
              </div>
            ...
            <div class="card mb20 pb5">
              <div class="card-header" id="headingFours">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFours" aria-expanded="true" aria-controls="collapseFours">Level</button>
                </h4>
              </div>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="card mb20 pb5">
                  <div class="card-header active" id="heading4">
                    <h4>
                      <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">Level</button>
                    </h4>
                  </div>
              ...
              <div class="col-md-6 col-lg-12">
                <div class="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div class="col-lg-8 ps-0">
                    <div class="d-lg-flex bdrr1 bdrn-lg">
                      <div class="thumb w90 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="images/team/fl-5.png" alt="">
                        <span class="online"></span>
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
                        <h5 class="title mb-1">Guy Hawkins</h5>
                        <p class="mb-0">UI/UX Designer</p>
                        <div class="review"><p><i class="fas fa-star fz10 review-color pr10"></i><span class="dark-color fw500">4.9</span> (595 reviews)</p></div>
                        <div class="skill-tags d-flex align-items-center justify-content-lg-center mb-0">
                          <span class="tag">Figma</span>
              ...
              <div class="col-md-6 col-lg-12">
                <div class="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div class="col-lg-8 ps-0">
                    <div class="d-lg-flex bdrr1 bdrn-lg">
                      <div class="thumb w90 position-relative rounded-circle mb15-md">
                        <img class="rounded-circle mx-auto" src="images/team/fl-6.png" alt="">
                        <span class="online"></span>
                      </div>
                      <div class="details ml15 ml0-md mb15-md">
                        <h5 class="title mb-1">Brooklyn Simmons</h5>
                        <p class="mb-0">UI/UX Designer</p>
                        <div class="review"><p><i class="fas fa-star fz10 review-color pr10"></i><span class="dark-color fw500">4.9</span> (595 reviews)</p></div>
                        <div class="skill-tags d-flex align-items-center justify-content-lg-center mb-0">
                          <span class="tag">Figma</span>
                ...
                <div class="freelancer-style1 bdr1 hover-box-shadow row ms-0">
                  <div class="col-lg-8 ps-0">
                    <div class="d-lg-flex bdrr1 bdrn-lg">
                      ...
                      <div class="details ml15 ml0-md mb15-md">
                        <h5 class="title mb-1">Darlene Robertson</h5>
                        <p class="mb-0">UI/UX Designer</p>
                        <div class="review"><p><i class="fas fa-star fz10 review-color pr10"></i><span class="dark-color fw500">4.9</span> (595 reviews)</p></div>
                        <div class="skill-tags d-flex align-items-center justify-content-lg-center mb-0">
                          <span class="tag">Figma</span>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-freelancer-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:50 GMT -->
</html>