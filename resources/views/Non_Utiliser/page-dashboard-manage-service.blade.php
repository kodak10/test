...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-manage-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:26 GMT -->
<head>
<meta charset="utf-8">
          ...
          <div class="row pb40">
            ...
            <div class="col-lg-3">
              <div class="text-lg-end">
                <a href="page-dashboard-add-service.html" class="ud-btn btn-dark default-box-shadow2">Add Service<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
          </div>
          <div class="row">
