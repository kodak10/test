...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-dashboard-manage-jobs.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:42 GMT -->
<head>
<meta charset="utf-8">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item active" href="page-dashboard-manage-jobs.html"><i class="flaticon-briefcase mr10"></i>Manage Jobs</a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="page-dashboard-manage-jobs.html" class="items-center -is-active"><i class="flaticon-briefcase mr15"></i>Manage Jobs</a>
          </div>
          <div class="sidebar_list_item ">
                          ...
                          <div class="freelancer-style1 p-0 mb-0 box-shadow-none">
                            <div class="d-lg-flex align-items-lg-center">
                              ...
                              <div class="details ml15 ml0-md mb15-md">
                                <h5 class="title mb-2">Marketing and Communications Manager</h5>
                                <h6 class="mb-0 text-thm">Mailchimp</h6>
                              </div>
                            </div>
                          </div>
                        </th>
                        <td class="vam"><span class="fz15 fw400">3+ Applied</span></td>
                        <td class="vam"><span>October 27, 2017</span><br><span class="fz14 fw400">April 25, 2011</span></td>
                        <td class="vam"><span class="pending-style style6">Active</span></td>
                        <td>
                          <div class="d-flex">
