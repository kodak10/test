...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-employee-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:43 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper ovh">
          ...
          <div class="accordion" id="accordionExample2">
            ...
            <div class="card mb20 pb5">
              <div class="card-header" id="headingThrees">
                <h4>
                  <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThrees" aria-expanded="true" aria-controls="collapseThrees">No of Employees</button>
                </h4>
              </div>
              <div id="collapseThrees" class="collapse" aria-labelledby="headingThrees" data-parent="#accordionExample">
                <div class="card-body card-body px-0 pt-0">
                  <div class="checkbox-style1">
                    <label class="custom_checkbox">1-10
                      <input type="checkbox">
                      <span class="checkmark"></span>
                      <span class="right-tags">(1,945)</span>
                    </label>
                    <label class="custom_checkbox">11-20
                      <input type="checkbox" checked="checked">
                      <span class="checkmark"></span>
                      <span class="right-tags">(8,136)</span>
                    </label>
                    <label class="custom_checkbox">21-30
                      <input type="checkbox">
                      <span class="checkmark"></span>
                      <span class="right-tags">(917)</span>
                    </label>
                    <label class="custom_checkbox">Less then 50
                      <input type="checkbox">
                      <span class="checkmark"></span>
                      <span class="right-tags">(240)</span>
                    </label>
  ...
  <div class="body_content">
    ...
    <section class="breadcumb-section pt-0">
      <div class="cta-employee-single cta-banner mx-auto maxw1700 pt120 pb120 bdrs16 position-relative d-flex align-items-center mx20-lg px30-lg">
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="card mb20 pb5">
                  <div class="card-header active" id="heading3">
                    <h4>
                      <button class="btn btn-link ps-0" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="true" aria-controls="collapse3">No of Employees</button>
                    </h4>
                  </div>
          ...
          <div class="col-lg-9">
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-4">
                <div class="job-list-style1 bdr1 pb10">
                  <div class="icon d-flex align-items-center mb20">
                    <img class="wa" src="images/team/client-1.png" alt="">
                    <h6 class="mb-0 ml20">Mailchimp</h6>
                    <span class="fav-icon flaticon-star"></span>
                  </div>
                  <div class="details">
                    <p class=""><i class="fas fa-star fz10 review-color pr10"></i><span class="dark-color">4.9</span> (595 reviews)</p>
                    <p class="list-inline-item mb-3">London, UK</p>
                    <p class="list-inline-item mb-3 bdrl1 pl15">Open 29 Jobs</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-xl-4">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="job-list-style1 bdr1 pb10">
                  <div class="icon d-flex align-items-center mb20">
                    ...
                    <h6 class="mb-0 ml20">Invision</h6>
                    <span class="fav-icon flaticon-star"></span>
                  </div>
                  <div class="details">
                    <p class=""><i class="fas fa-star fz10 review-color pr10"></i><span class="dark-color">4.9</span> (595 reviews)</p>
