...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-project-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:08 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="col-xl-7">
              <div class="position-relative">
                ...
                <div class="list-meta mt15">
                  <p class="mb-0 dark-color fz15 fw500 list-inline-item mb5-sm"><i class="flaticon-place vam fz20 text-thm2 me-2"></i> London, UK</p>
                  <p class="mb-0 dark-color fz15 fw500 list-inline-item ml15 mb5-sm ml0-xs"><i class="flaticon-calendar text-thm2 vam fz20 me-2"></i> January 15, 2022</p>
                  <p class="mb-0 dark-color fz15 fw500 list-inline-item ml15 mb5-sm ml0-xs"><i class="flaticon-website text-thm2 vam fz20 me-2"></i> 902 Views</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-8">
            <div class="column">
              ...
              <div class="service-about">
                ...
                <h4 class="mb30">Project Proposals (3)</h4>
                <div class="row">
                    ...
                    <div class="freelancer-style1 bdr1 hover-box-shadow row ms-0 align-items-start">
                        ...
                        <div class="d-lg-flex">
                          ...
                          <div class="details ml20 ml0-md mb15-md">
                            ...
                            <div class="review mb20">
                              <p class="mb-0 fz14 list-inline-item mb5-sm pe-1"><i class="fas fa-star fz10 review-color pr10"></i> <span class="dark-color">4.9</span> (595 reviews)</p>
                              <p class="mb-0 fz14 list-inline-item mb5-sm pe-1"><i class="flaticon-30-days fz16 vam text-thm2 me-1 bdrl1 bdrn-md pl15 pl0-md bdrn-xs"></i> 2 hours ago</p>
                              <p class="mb-0 fz14 list-inline-item mb5-sm"><i class="flaticon-contract fz16 vam text-thm2 me-1 bdrl1 bdrn-md pl15 pl0-md bdrn-xs"></i> 1 Received</p>
                            </div>
                            <p class="text mb-0">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-2 px-0">
                        <div class="text-lg-center text-xl-end mt-0 mt-lg-2 mt-xl-0">
                          <h4>$100 - $150</h4>
                          <p class="text mb-0">in 100 hours</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="bsp_reveiw_wrt mt25">
                  ...
                  <form class="comments_form mt30 mb30-md">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb20">
                          <label class="fw500 ff-heading dark-color mb-2">Your hourly price</label>
                          <input type="text" class="form-control" placeholder="$99">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb20">
                          <label class="fw500 ff-heading dark-color mb-2">Estimated Hours</label>
                          <input type="text" class="form-control" placeholder="4">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="mb-4">
                          <label class="fw500 fz16 ff-heading dark-color mb-2">Cover Letter</label>
                      ...
                      <div class="col-md-12">
                        <div class="d-grid">
                          <a href="#" class="ud-btn btn-thm">Submit a Proposal<i class="fal fa-arrow-right-long"></i></a>
                        </div>
                      </div>
                    </div>
                  </form>
            ...
            <div class="column">
              <div class="blog-sidebar ms-lg-auto">
                <div class="price-widget pt25 bdrs8">
                  <h3 class="widget-title">$100 - $150</h3>
                  <p class="text fz14">Hourly Rate</p>
                  <div class="d-grid">
                    <a href="page-contact.html" class="ud-btn btn-thm">Submit a Proposal<i class="fal fa-arrow-right-long"></i></a>
                  </div>
                </div>
...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-project-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 22:59:10 GMT -->
</html>
<script>
