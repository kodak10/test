...
<!-- Mirrored from creativelayers.net/themes/freeio-html/page-help.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 23:04:34 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row">
          <div class="col-lg-6 m-auto wow fadeInUp" data-wow-delay="300ms">
            <div class="main-title text-center">
              ...
              <div class="search_widgets mt30">
                <form>
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Search">
                  </div>
                  <div class="help_search_btn">
                    <button type="submit" class="btn search-btn"><span class="far fa-magnifying-glass"></span></button>
                  </div>
                </form>
              </div>
            </div>
